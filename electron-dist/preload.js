/**
 * Preload script — must be CommonJS (Electron requirement).
 * Exposes window.shirim via contextBridge for secure IPC.
 *
 * This file is NOT compiled from TypeScript — it's hand-written CJS
 * because Electron preload scripts cannot be ESM modules.
 */
const { contextBridge, ipcRenderer } = require('electron');

const shirimApi = {
  install: {
    start: (owner, repo, ref, authToken) =>
